    ...
    return (
        <>
            <StyledTable
                ...
                footer={
                    isLastPage ? (
                        <TableFooter hiddenItemsMessage={t('ingestion.executions_hidden_message')} colSpan={tableColumns.length} />
                    ) : null
                }
