                        ...
                        <IngestionBoxTopRow>
                            ...
                            <Pill
                                ...
                                label={
                                    item.count === 0
                                        ? t('ingestion.missing')
                                        : t('ingestion.percent_of_total', { percent: item.percent })
                                }
                            />
                        </IngestionBoxTopRow>
                    }
...
export default function IngestedAssets({ id, executionResult, urn }: Props) {
    ...
    return (
        <>
            ...
            {!loading && total === 0 && <Text>{t('ingestion.no_assets_ingested')}</Text>}
            {!loading && total > 0 && (
                <>
                    <MainContainer>
                        <TotalSection>
                    ...
                    {ingestionContents && (
                        <IngestionContentsContainer>
                            <Heading type="h5" size="lg" weight="bold">
                                {t('ingestion.coverage')}
                            </Heading>
                            <SubTitleContainer>
                                <Text color="gray" colorLevel={600} lineHeight="sm">
                                    {t('ingestion.coverage_desc')}
                                </Text>
                            </SubTitleContainer>
                            <SectionSmallTitle>
            ...
            {showAssetSearch && (
                <EmbeddedListSearchModal
                    title={t('ingestion.view_ingested_assets')}
