...
import { translateButtonLabel, translateLabel } from '@app/ingestV2/source/builder/RecipeForm/common';
    ...
    return (
        <Form.List name={field.name} rules={field.rules || undefined}>
            {(fields, { add, remove }, { errors }) => (
                <ListWrapper>
                    <FieldLabel label={translateLabel(field.label, t)} required={field.required} />
                    ...
                    <AddItemButton onClick={() => add()} text={translateButtonLabel(field.buttonLabel, t)} />
