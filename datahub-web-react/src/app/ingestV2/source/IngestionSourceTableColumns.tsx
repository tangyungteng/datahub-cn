...
export function NameColumn({ type, record, onNameClick }: NameColumnProps) {
    ...
    return (
        <NameContainer>
            ...
            {record.cliIngestion && (
                <Tooltip title={t('ingestion.cli_source_tooltip')}>
...
export function ScheduleColumn({ schedule, timezone }: { schedule: string; timezone?: string }) {
    ...
    try {
        ...
        scheduleText = t('ingestion.invalid_cron_schedule');
...
export function ActionsColumn({
    ...
    if (record.lastExecUrn) {
        items.push({
            ...
            label: (
                ...
                >
                    {t('ingestion.view_last_run_result')}
                </MenuItem>
            ),
        });
    }
    ...
    items.push({
        ...
        label: (
            ...
            >
                <Text color="red">{t('action.delete')} </Text>
            </MenuItem>
        ),
    });
        ...
        if (record.lastExecStatus === EXECUTION_REQUEST_STATUS_RUNNING) {
            return (
                <Icon
                    ...
                    tooltipText={t('ingestion.stop_execution')}
                />
            );
        }
        return (
            <Icon
                ...
                tooltipText={t('ingestion.execute')}
