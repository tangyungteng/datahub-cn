...
export const IngestionSourceBuilderModal = ({
    ...
    const titleText = isEditing ? t('ingestion.edit_title') : t('ingestion.connect_title');
    const stepTitleMap: Record<string, string> = {
        SELECT_TEMPLATE: t('ingestion.step_choose'),
        DEFINE_RECIPE: t('ingestion.step_configure'),
        CREATE_SCHEDULE: t('ingestion.step_schedule'),
        NAME_SOURCE: t('ingestion.step_finish'),
    };
                    ...
                    <StepsContainer>
                        <Steps current={currentStepIndex}>
                            {Object.keys(IngestionSourceBuilderStep).map((item) => (
                                <Steps.Step key={item} title={stepTitleMap[item]} />
                            ))}
                        </Steps>
                    </StepsContainer>
                ) : null}
