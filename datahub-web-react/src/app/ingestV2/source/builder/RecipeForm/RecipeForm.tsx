...
import { FilterRecipeField, RecipeField, setFieldValueOnRecipe, translateSection } from '@app/ingestV2/source/builder/RecipeForm/common';
    ...
    return (
        ...
        >
            <StyledCollapse defaultActiveKey="0">
                <Collapse.Panel forceRender header={<SectionHeader icon={<ApiOutlined />} text={t('ingestion.connection')} />} key="0">
                        ...
                        {filterFields.map((field, i) => (
                            <Fragment key={field.name}>
                                {shouldRenderFilterSectionHeader(field, i, filterFields) && (
                                    <Typography.Title level={4}>{translateSection(field.section, t)}</Typography.Title>
                                )}
                                <MarginWrapper>
                                    <FormField
                                        field={field}
            ...
            <ControlsContainer>
                ...
                <Button data-testid="recipe-builder-next-button">{t('action.next')}</Button>
            </ControlsContainer>
        </RequiredFieldForm>
    );
}
