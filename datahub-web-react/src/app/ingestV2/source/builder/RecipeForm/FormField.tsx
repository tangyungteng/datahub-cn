...
import { FieldType, RecipeField, translateButtonLabel, translateLabel } from '@app/ingestV2/source/builder/RecipeForm/common';
            ...
            {(fields, { add, remove }, { errors }) => (
                <ListWrapper removeMargin={!!removeMargin}>
                    ...
                    <StyledButton type="dashed" onClick={() => add()} style={{ width: '80%' }} icon={<PlusOutlined />}>
                        {translateButtonLabel(field.buttonLabel, t)}
                    </StyledButton>
...
function SelectField({ field, removeMargin }: CommonFieldProps) {
    ...
    return (
        <StyledFormItem
            ...
            name={field.name}
            label={translateLabel(field.label, t)}
