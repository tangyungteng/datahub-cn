...
function IngestionSourceTable({
    ...
    const tableColumns: Column<IngestionSourceTableData>[] = [
        ...
        {
            title: t('ingestion.col_last_run'),
            key: 'lastRun',
    ...
    return (
        <StyledTable
            ...
            footer={
                isLastPage ? (
                    <TableFooter
                        hiddenItemsMessage={t('ingestion.sources_hidden_message')}
