...
export const ManageIngestionPage = () => {
    ...
    const tabs: Tab[] = [
        ...
        },
        {
            ...
            name: t('ingestion.tab_run_history'),
        },
        showSecretsTab && {
            component: (
    ...
    return (
        <PageContainer $isShowNavBarRedesign={isShowNavBarRedesign}>
            ...
            <PageHeaderContainer>
                <TitleContainer>
                    <PageTitle
                        title={t('ingestion.manage_title')}
                        subTitle={t('ingestion.manage_desc')}
                    />
                </TitleContainer>
