    ...
    return (
        <Background>
            <Row justify="space-between" style={styles.navBar}>
                <WelcomeText>
                    {!!user && t('home.welcome', { name: entityRegistry.getDisplayName(EntityType.CorpUser, user) })}
                </WelcomeText>
                <NavGroup>
                    <HeaderLinks />
                    <ManageAccount
            ...
            <HeaderContainer>
                ...
                <SearchBarContainer id={HOME_PAGE_SEARCH_BAR_ID}>
                    <SearchBar
                        placeholderText={t('search.global_placeholder')}
                    ...
                    {searchResultsToShow && searchResultsToShow.length > 0 && (
                        <SuggestionsContainer>
                            <SuggestionsHeader>
                                <SuggestedQueriesText strong>{t('home.try_searching')}</SuggestedQueriesText>
                                <ExploreAllButton type="link" onClick={onClickExploreAll}>
                                    {t('home.explore_all')} <StyledRightOutlined />
                                </ExploreAllButton>
                            </SuggestionsHeader>
