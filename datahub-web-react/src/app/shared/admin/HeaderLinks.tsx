    ...
    const items = [
        {
            ...
            label: (
                <Link to="/glossary">
                    ...
                    <NavTitleDescription>{t('nav.glossary_desc')}</NavTitleDescription>
                </Link>
            ),
        },
        {
            ...
            label: (
                <Link to="/domains">
                    ...
                    <NavTitleDescription>{t('nav.domains_desc')}</NavTitleDescription>
                </Link>
            ),
        },
                      ...
                      label: (
                          <Link to="/business-attribute">
                              <NavTitleContainer>
                                  ...
                                  />
                                  <NavTitleText>{t('nav.business_attribute')}</NavTitleText>
                              </NavTitleContainer>
                              <NavTitleDescription>{t('nav.business_attribute_desc')}</NavTitleDescription>
                          </Link>
                      ),
                  },
              ]
                      ...
                      label: (
                          <Link to={PageRoutes.STRUCTURED_PROPERTIES}>
                              <NavSubItemTitleContainer>
                                  ...
                                  <NavTitleText>{t('nav.structured_properties')}</NavTitleText>
                              </NavSubItemTitleContainer>
                              <NavTitleDescription>{t('nav.structured_properties_desc')}</NavTitleDescription>
                          </Link>
                      ),
                  },
              ]
        ...
        <LinksWrapper areLinksHidden={areLinksHidden}>
            {showAnalytics && (
                <LinkWrapper>
                    <Link to="/analytics">
                        <Button type="text">
                            <Tooltip title={t('nav.analytics_desc')}>
                                <NavTitleContainer>
                                    <BarChartOutlined />
                ...
                <LinkWrapper>
                    <Link to="/ingestion">
                        <Button id={HOME_PAGE_INGESTION_ID} type="text">
                            <Tooltip title={t('nav.ingestion_desc')}>
                                <NavTitleContainer>
                                    <ApiOutlined />
            ...
            {showSettings && (
                <LinkWrapper style={{ marginRight: 12 }}>
                    <Link to="/settings">
                        <Button type="text">
                            <Tooltip title={t('nav.settings_desc')}>
                                <SettingOutlined />
                            </Tooltip>
                        </Button>
                    </Link>
