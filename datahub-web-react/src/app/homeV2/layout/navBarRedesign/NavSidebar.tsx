...
export const NavSidebar = () => {
        ...
        items: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        type: NavBarMenuItemTypes.Item,
                        title: t('nav.business_attribute'),
                    ...
                    {
                        type: NavBarMenuItemTypes.Item,
                        title: t('nav.structured_properties'),
    ...
    const footerMenu: NavBarMenuItems = {
        items: [
            ...
            {
                type: NavBarMenuItemTypes.Item,
                title: i18n.language === 'zh' ? t('account.switch_to_english') : t('account.switch_to_chinese'),
                icon: <GlobalOutlined />,
                key: 'language',
