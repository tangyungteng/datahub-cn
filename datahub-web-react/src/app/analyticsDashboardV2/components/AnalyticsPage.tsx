...
export const AnalyticsPage = () => {
    ...
    const options: SelectOption[] = [{ value: 'ALL', label: t('analytics.all_domains') }, ...domainOptions];
            ...
            {!isLoading && (
                <>
                    ...
                    {chartData?.getAnalyticsCharts
                        ...
                        .map((chartGroup) => (
                            <ChartGroup
                                chartGroup={{ ...chartGroup, title: t('analytics.data_landscape') }}
                                key={chartGroup.title}
                            />
                        ))}

                    <DomainSection>
                        <PageTitle title={t('analytics.domain_landscape')} variant="sectionHeader" />
                        <FilterSection>
                            {domainError && (
                                <Alert
                                    type="error"
                    ...
                    {chartData?.getAnalyticsCharts
                        ...
                        .map((chartGroup) => (
                            <React.Fragment key={chartGroup.title}>
                                <ChartGroup chartGroup={{ ...chartGroup, title: t('analytics.usage_title') }} />
                            </React.Fragment>
                        ))}
                </>
            )}
