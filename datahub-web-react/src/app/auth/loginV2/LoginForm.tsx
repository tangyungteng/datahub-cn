    ...
    return (
        <FormContainer>
            <Form form={form} onFinish={handleSubmit} onFieldsChange={onFormChange} onKeyDown={handleKeyDown}>
                <ItemContainer>
                    <FieldLabel label={t('login.username')} required />
                    <Form.Item rules={[{ required: true, message: t('login.fill_username') }]} name="username">
                        <Input placeholder={t('login.enter_username')} inputTestId="username" />
                    </Form.Item>
                </ItemContainer>

                <ItemContainer>
                    <FieldLabel label={t('login.password')} required />
                    <Form.Item rules={[{ required: true, message: t('login.fill_password') }]} name="password">
