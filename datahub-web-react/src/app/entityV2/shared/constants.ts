...
// 文案改为 i18n key 模式（entity 命名空间），使用处需通过 t() 解析
export const EMPTY_MESSAGES = {
    ...
    application: {
        title: 'entity:empty.application_title',
        description: 'entity:empty.application_desc',
    },
    contains: {
    ...
    structuredProps: {
        title: 'entity:empty.structured_props_title',
    },
};
