...
export const RelatedSection: React.FC = () => {
    ...
    return (
        <>
            <SectionContainer>
                <SectionHeader>
                    <SectionTitle>{t('entity.documentation.resources')}</SectionTitle>
                    {supportsRelatedDocuments && menuItems.length > 0 && (
                        ...
                        >
                            <Menu items={menuItems} placement="bottomRight">
                                <Tooltip title={t('entity.documentation.add_related')}>
                                    <Button
                                        variant="text"
                                        isCircle
                                        icon={{ icon: 'Plus', source: 'phosphor' }}
                                        aria-label={t('entity.documentation.add_related')}
