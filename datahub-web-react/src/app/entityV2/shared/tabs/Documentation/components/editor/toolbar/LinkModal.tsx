...
export const LinkModal = (props: LinkModalProps) => {
    ...
    return (
        <Modal
            title={t('entity.documentation.add_link')}
            okText={t('action.save')}
            onCancel={handleClose}
            buttons={[
                {
                    text: t('entity.documentation.link'),
                    variant: 'filled',
                    onClick: handleOk,
                },
            ]}
        ...
        >
            ...
            >
                <Form.Item
                    name="href"
                    label={<Typography.Text strong>{t('entity.documentation.link_url')}</Typography.Text>}
                    rules={[{ required: true }]}
                >
                    <Input placeholder="https://www.google.com" autoFocus />
                </Form.Item>
                <Form.Item name="text" label={<Typography.Text strong>{t('entity.documentation.text')}</Typography.Text>}>
                    <Input />
                </Form.Item>
            </Form>
        </Modal>
