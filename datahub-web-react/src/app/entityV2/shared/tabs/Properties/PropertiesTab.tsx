    ...
    return (
        <>
            ...
            <StyledTable
                ...
                locale={{
                    emptyText: <EmptyText description={t('entity.properties.no_properties_found')} image={Empty.PRESENTED_IMAGE_SIMPLE} />,
                }}
