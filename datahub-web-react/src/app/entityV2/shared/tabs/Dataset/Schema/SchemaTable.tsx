...
export default function SchemaTable({
    ...
    const descriptionColumn = useMemo(
        () => ({
            ...
            title: t('entity.schema.description'),
    ...
    const termColumn = useMemo(
        () => ({
            width: 200,
            title: t('entity.schema.glossary_terms'),
            dataIndex: 'globalTags',
            key: 'term',
            render: termRenderer,
            sorter: (sourceA, sourceB) =>
    ...
    const businessAttributeColumn = useMemo(
        () => ({
            width: 150,
            title: t('entity.schema.business_attribute'),
