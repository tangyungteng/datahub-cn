    ...
    return (
        <StatSection>
            <Typography.Title level={5}>
                {isPartitioned
                    ? t('entity.stats.partition_stats', { partition: partitionSpec.partition })
                    : t('entity.stats.table_stats')}
            </Typography.Title>
            <StatContainer justifyContent={justifyContent}>
                {rowCount && (
                    <InfoItem title={t('entity.stats.rows')}>
                ...
                {columnCount && (
                    <InfoItem title={t('entity.stats.columns')}>
                ...
                {queryCount && (
                    <InfoItem title={t('entity.stats.monthly_queries')}>
                        <Typography.Text strong style={{ fontSize: 24 }}>
                            {queryCount}
                        </Typography.Text>
                    </InfoItem>
                ...
                {sortedUsers && sortedUsers.length > 0 && (
                    <InfoItem title={t('entity.stats.top_users')} width="inherit">
                ...
                {lastUpdatedTime && (
                    <InfoItem title={t('entity.stats.last_updated')} width="220px">
