            ...
            label: (
                ...
                >
                    <span data-testid="lineage-tab-direction-select-option-downstream">
                        ...
                        <b>{t('entity.lineage.downstreams')}</b>
                    </span>
                </Tooltip>
            ),
            ...
            label: (
                ...
                >
                    <span data-testid="lineage-tab-direction-select-option-upstream">
                        ...
                        <b>{t('entity.lineage.upstreams')}</b>
                    </span>
                </Tooltip>
            ),
        ...
        <>
            <StyledTabToolbar>
                ...
                <RightButtonsWrapper>
                    ...
                    <Tooltip title={isLoading ? t('entity.lineage.refreshing_data') : t('entity.lineage.refresh_lineage')} showArrow={false}>
                        <RefreshCacheButton type="text" onClick={() => setSkipCache(true)} disabled={isLoading}>
                            {isLoading ? <LoadingOutlined /> : <ReloadOutlined />}
                            <Typography.Text>
                                <b>{t('entity.lineage.refresh')}</b>
                            </Typography.Text>
                        </RefreshCacheButton>
                    </Tooltip>
                </RightButtonsWrapper>
