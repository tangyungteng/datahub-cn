...
function CreateGlossaryEntityModal(props: Props) {
    ...
    return (
        <Modal
            title={
                !selectedParentUrn && entityType === EntityType.GlossaryNode
                    ? t('glossary.create')
                    : `${t('action.create')} ${entityRegistry.getEntityName(entityType)}`
            }
            buttons={[
                {
        ...
        >
            ...
            >
                <Form.Item label={<Typography.Text strong>{t('form.name')}</Typography.Text>}>
                    <StyledItem
                    ...
                    <Form.Item
                        label={
                            <Typography.Text strong>
                                {t('form.parent')} <OptionalWrapper>{t('form.optional')}</OptionalWrapper>
                            </Typography.Text>
                        }
                    >
                ...
                <StyledItem
                    label={
                        <Typography.Text strong>
                            {t('form.documentation')} <OptionalWrapper>{t('form.optional')}</OptionalWrapper>
                        </Typography.Text>
                    }
                >
                    <Button variant="text" onClick={() => setIsDocumentationModalVisible(true)}>
                        <EditOutlined />
                        {documentation ? t('form.edit_documentation') : t('form.add_documentation')}
                    </Button>
                    {isDocumentationModalVisible && (
                        <DescriptionModal
                            title={t('form.add_documentation')}
                ...
                <Collapse ghost>
                    <Collapse.Panel header={<Typography.Text type="secondary">{t('form.advanced')}</Typography.Text>} key="1">
                        <Form.Item
                            label={
                                <Typography.Text strong>
