...
export default function DataProductSection({ readOnly }: Props) {
    ...
    return (
        <>
            <SidebarSection
                title={isMultipleDataProductsEnabled ? t('entity:sidebar.data_products') : t('entity:sidebar.data_product')}
                content={
                    <Content>
                        {dataProducts.length > 0 ? (
                            ...
                            <EmptySectionText message={t(EMPTY_MESSAGES.dataProduct.title)} />
                        )}
                    </Content>
                }
                extra={
