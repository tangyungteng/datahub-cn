...
const TabTextWithTooltip = ({ text, isSelected }: { text: string; isSelected?: boolean }) => {
    ...
    const tooltipText = text === t('sidebar_tabs.props') ? t('sidebar_tabs.structured_properties') : text;
                                ...
                                <TabIconContainer $isSelected={isSelected}>
                                    ...
                                    <TabTextWithTooltip
                                        text={(() => {
                                            switch (name) {
                                                case 'Summary':
                                                    return t('sidebar_tabs.summary');
                                                case 'Properties':
                                                    return t('sidebar_tabs.props');
                                                case 'Columns':
                                                    return t('sidebar_tabs.columns');
                                                case 'Lineage':
                                                    return t('sidebar_tabs.lineage');
                                                default:
                                                    return translateEntityTabName(name, tCommon);
                                            }
                                        })()}
