...
const ENABLED_TAB_PATHS = [TabType.Assets.toLocaleLowerCase(), TabType.Groups.toLocaleLowerCase()];
...
export default function UserProfile({ urn }: Props) {
    ...
    const getTabs = () => {
        ...
        ].filter((tab) => ENABLED_TAB_PATHS.includes(tab.path));
    };
