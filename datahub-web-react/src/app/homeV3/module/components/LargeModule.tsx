...
import { getModuleNameI18nKey } from '@app/homeV3/modules/utils';
...
function LargeModule({
    ...
    const nameI18nKey = getModuleNameI18nKey(module);
    const displayName = nameI18nKey ? t(nameI18nKey) : name;
