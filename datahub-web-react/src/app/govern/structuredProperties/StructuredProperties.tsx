    ...
    return (
        <PageContainer $isShowNavBarRedesign={isShowNavBarRedesign}>
            <HeaderContainer>
                <HeaderContent>
                    <PageTitle
                        title={t('structured_props.title')}
                        pillLabel={totalCount ? totalCount.toString() : undefined}
                        subTitle={t('structured_props.subtitle')}
                    />
                </HeaderContent>
                <Tooltip
                    showArrow={false}
                    title={
                        !canEditProps
                            ? t('structured_props.no_permission_tooltip')
                            : null
                    }
                >
                    <ButtonContainer>
                        ...
                        >
                            {t('structured_props.create')}
                        </Button>
                    </ButtonContainer>
                </Tooltip>
            </HeaderContainer>
            <SearchBar
                placeholder={t('structured_props.search_placeholder')}
                value={searchQuery}
