    ...
    const menuItems: NavBarMenuItems = {
        items: [
            // Personal Section
            {
                ...
                title: t('settings.group_personal'),
                key: 'personal',
                items: [
                    {
            ...
            {
                type: NavBarMenuItemTypes.Group,
                title: t('settings.group_developer'),
                key: 'developer',
                items: [
                    {
                        type: NavBarMenuItemTypes.Item,
                        title: t('settings.access_tokens'),
                        key: 'tokens',
                        link: `${url}/tokens`,
            ...
            {
                type: NavBarMenuItemTypes.Group,
                title: t('settings.group_access'),
                key: 'access',
                items: [
                    {
                        type: NavBarMenuItemTypes.Item,
                        title: t('settings.users_groups'),
                        key: 'identities',
                        link: `${url}/identities`,
            ...
            // Manage Section
            {
                ...
                items: [
                    ...
                    {
                        type: NavBarMenuItemTypes.Item,
                        title: t('settings.ownership_types'),
                        key: 'ownership',
                        link: `${url}/ownership`,
            ...
            {
                type: NavBarMenuItemTypes.Group,
                title: t('settings.group_preferences'),
                key: 'preferences',
                items: [
                    {
                        type: NavBarMenuItemTypes.Item,
            ...
            <NavBarContainer>
                <NavBarHeader>
                    <div>
                        ...
                        <NavBarSubTitle>{t('settings.subtitle')}</NavBarSubTitle>
                    </div>
